...
public class Laud {
    ...
    public class Pilt extends StackPane {
        ...
        public void Klikk(MouseEvent event){
            if (KasAvatud() || klikiLugeja==0)//Kui kaart on avatud ja selle peale uuesti vajutada, siis tagastab sama kaardi ehk ei juhtu midagi.
                return;
